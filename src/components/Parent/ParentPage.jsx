...
import logo from "../../assets/images/login.jpg"; // ✅ Make sure the path is correct
...
const ParentLogin = () => {
  ...
  const handleSignIn = () => {
    navigate("/parentprofile"); // ✅ Redirect to parent profile
  };
          ...
          <div className="w-3/5 bg-gray-100 p-8 flex items-center justify-center">
            <div className="w-full bg-white bg-opacity-95 p-6 rounded shadow-md">
              <h2 className="text-2xl font-bold mb-6 text-[#003566]">
                ...
                <span className="font-semibold text-red-600">Parent Login</span>
              </h2>
