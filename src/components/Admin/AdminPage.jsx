...
import logo from "../../assets/images/login.jpg"; // ✅ Ensure this path is correct
...
const AdminLogin = () => {
  ...
  // ✅ Navigate directly on Sign In
  const handleSignIn = () => {
    navigate("/adminprofile"); // 🔁 Change to your actual route
  };
          ...
          <div className="w-3/5 bg-gray-100 p-8 flex items-center justify-center">
            <div className="w-full bg-white bg-opacity-95 p-6 rounded shadow-md">
              <h2 className="text-2xl font-bold mb-6 text-[#003566]">
                ...
                <span className="font-semibold text-red-600">Admin Login</span>
              </h2>
